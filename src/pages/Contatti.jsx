        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
            <motion.a
              ...
              className="group bg-primary rounded-3xl p-8 md:p-10 hover:opacity-95 transition-opacity"
            >
              ...
              <span className="inline-block font-body text-sm font-semibold text-primary-foreground tracking-wide uppercase group-hover:underline">
                Chatta con noi →
              </span>
            </motion.a>
            ...
            <motion.a
              ...
              viewport={{ once: true }}
              className="group bg-card rounded-3xl p-8 md:p-10 border border-foreground/10 hover:border-foreground/20 transition-colors"
            >
              <div className="flex items-center gap-3 mb-6">
              ...
              <span className="inline-block font-body text-sm font-semibold text-foreground/80 tracking-wide uppercase group-hover:underline">
                @nicoletrend.shop →
              </span>
            </motion.a>
          </div>
