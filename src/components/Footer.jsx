    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Links */}
          <div>
            <h4 className="font-heading text-lg font-semibold mb-6">Navigazione</h4>
            <div className="flex flex-col gap-3">
              <Link to="/" className="font-body text-sm opacity-70 hover:opacity-100 transition-opacity">Home</Link>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading text-lg font-semibold mb-6">Contatti</h4>
        ...
        <div className="mt-16 pt-8 border-t border-primary-foreground/20">
          <p className="font-body text-xs opacity-50 text-center">
            © {new Date().getFullYear()} Nicole Trend Shop. Tutti i diritti riservati.
          </p>
        </div>
      </div>
    </footer>
